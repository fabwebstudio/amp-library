...
class ValidationRulesFactory {
  public static function createValidationRules() {
    ...
    $o_1288->spec_name = 'amp-auto-ads extension .js script';
    $o_1288->mandatory_parent = 'head';
    $o_1288->attrs[] = $o_703;
    $o_1289 = new AttrSpec();
    $o_1289->name = 'custom-element';
    $o_1289->mandatory = true;
    $o_1289->value = 'amp-auto-ads';
    $o_1289->dispatch_key = true;
    $o_1288->attrs[] = $o_1289;
    $o_1290 = new AttrSpec();
    $o_1290->name = 'src';
    $o_1290->mandatory = true;
    $o_1290->value_regex = 'https://cdn\\.ampproject\\.org/v0/amp-auto-ads-(latest|0\\.1).js';
    $o_1288->attrs[] = $o_1290;
    $o_1288->spec_url = 'https://www.ampproject.org/docs/reference/extended/amp-auto-ads.html';
    $o_1291 = new CdataSpec();
    $o_1292 = new BlackListedCDataRegex();
    $o_1292->regex = '.';
    $o_1292->error_message = 'contents';
    $o_1291->blacklisted_cdata_regex[] = $o_1292;
    $o_1288->cdata = $o_1291;
    $o_0->tags[] = $o_1288;
    $o_1293 = new TagSpec();
    $o_1293->tag_name = 'amp-auto-ads';
    $o_1294 = new AttrSpec();
    $o_1294->name = 'type';
    $o_1294->value = 'adsense';
    $o_1293->attrs[] = $o_1294;
    $o_1295 = new AttrSpec();
    $o_1295->name = 'data-ad-client';
    $o_1295->value = 'ca-pub-3590687033817056';
    $o_1293->attrs[] = $o_1295;
    $o_0->tags[] = $o_1293;
